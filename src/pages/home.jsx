          ...
          if (contract) {
            try {
                ...
                if(current.blockHash){
                  ...
                  // const nickname = await contract.methods.getNickname().call();
                  // signIn(nickname);
                }
        ...
        <div className="w-[30%] p-6 space-y-6">
          ...
          <div className="relative group">
            ...
            <button className="relative w-full px-7 py-4 bg-black rounded-lg leading-none flex items-center justify-center space-x-3" onClick={onLogout}>
              ...
              {/* <span className="bg-purple-700 px-3 py-1 rounded-full text-white group-hover:bg-white group-hover:text-purple-900 transition duration-200">
                Free
              </span> */}
            </button>
          </div>
